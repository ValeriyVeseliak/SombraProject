					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form action="/SombraStore/admin/goods/${good.id}/update">
								...
								<div class="form-group">
									<label for="decription"> Description</label> <input type="text"
										name="description" value="${good.description}">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="cathName">Cathegory</label> <select name="cathName">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="/SombraStore/admin/goods/create">
					...
					<div class="form-group">
						<label for="cathName">Cathegory</label> <select name="cathegories">
							<c:forEach items="${cathegories}" var="cathegory">
								<option value="${cathegory.cathName}">${cathegory.cathName}</option>
							</c:forEach>
						</select>
